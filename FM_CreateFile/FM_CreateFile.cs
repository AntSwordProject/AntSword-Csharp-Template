    ...
    public class Run
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            try
            {
                ...
                result += this.CreateFileCode(path, content);
            }
            catch (Exception e)
            {
        ...
        public string CreateFileCode(String path, String content)
        {
            String ret = "";
            StreamWriter m = new StreamWriter(path, false, Encoding.GetEncoding(cs));
            m.Write(content);
            ret = "1";
            m.Close();
            return ret;
